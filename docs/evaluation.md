...
The initial targets are GPT-5.6 Sol through Codex CLI, Claude Opus 4.8 through Claude Code, and Claude Fable 5 through Claude Code. Raw prompts and trajectories stay local; published summaries contain redacted evidence and aggregate metrics only.
