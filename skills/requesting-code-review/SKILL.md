...
Use a fresh host-native reviewer when one is available, current policy permits it, and the named risk justifies the cost. If no independent reviewer is available, describe the result as self-review rather than claiming independence.
