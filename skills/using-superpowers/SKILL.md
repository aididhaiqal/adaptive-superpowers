...
2. Implement the accepted change. When feasible, create or update a runnable automated test file that protects observable behavior; transient checks do not count. When automation is infeasible, state why.
