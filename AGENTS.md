...
Keep the runtime inventory at 13 skills unless an approved design changes it. Do not restore `dispatching-parallel-agents`, `subagent-driven-development`, or `writing-implementation-logs` as runtime skills. Do not add model-specific profiles without repeated model-specific evaluation evidence.
