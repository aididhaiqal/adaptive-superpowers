...
require_text "$ROUTER" 'before an editing batch, editing delegation, commit, or branch operations'
...
require_text "$WORKTREES" 'Unrelated changes mean the current checkout is not appropriate isolation for new material work.'
